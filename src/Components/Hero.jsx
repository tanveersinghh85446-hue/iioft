...
const COURSES = [
  {
    icon: <FaCode />,
    title: "Data Science",
    description: "Learn Python, ML, Analytics & AI",
  },
  {
    icon: <FaCode />,
    title: "Web Development",
    description: "Full Stack, MERN, Node.js & Databases",
  },
  {
    icon: <FaPen />,
    title: "Digital Marketing",
    description: "SEO, SEM, Social Media & Content",
  },
  {
    icon: <FaLock />,
    title: "Ethical Hacking",
    description: "Cybersecurity, Network & Penetration Testing",
  },
  {
    icon: <FaCloud />,
  ...
  },
  {
    ...
    description: "Power BI, Tableau & Excel Advanced",
  },
  {
    icon: <FaCode />,
  ...
  },
  {
    ...
    description: "Big Data, Spark & Hadoop",
  },
  {
    icon: <FaPen />,
    title: "Copywriting",
    description: "Content Writing & Email Marketing",
  },
];
...
const JOB_PROFILES = [
  ...
  },
  {
    ...
    package: "16-28 LPA",
    companies: "IBM, Deloitte, Accenture",
  },
  {
...
const FAQS = [
  {
    question: "What courses are available at IIOFT?",
    answer:
      "IIOFT offers 75+ industry-relevant courses including Data Science, Web Development, Digital Marketing, Ethical Hacking, Cloud Computing, and Artificial Intelligence/Machine Learning. All programs include hands-on training and provide globally recognized certifications.",
  },
  {
    question: "Does IIOFT offer a 100% placement guarantee?",
    answer:
  ...
  return (
    <div>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="IIOFT Delhi - India's leading futuristic technology institute. 75+ Courses in Data Science, Web Development, Digital Marketing, Ethical Hacking. 100% Placement Support."
        />
        <meta
          name="keywords"
          content="IIOFT, International Institute of Futuristic Technology, technology institute Delhi, data science Delhi, web development Delhi, digital marketing Delhi, ethical hacking Delhi, best institute Dwarka"
        ...
        <meta
          property="og:description"
          content="IIOFT Delhi - India's leading futuristic technology institute. 75+ Courses. 100% Placement Support. Enroll Now!"
        />
        <meta property="og:url" content="https://iioft.co.in" />
        <meta property="og:type" content="website" />
        <link rel="canonical" href="https://iioft.co.in" />
      ...
      <section className="relative w-full h-screen flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 px-6 max-w-4xl text-white">
          ...
          <p className="mt-6 text-base sm:text-lg md:text-xl lg:text-2xl font-semibold drop-shadow-md">
            ...
            <span className="text-yellow-400">Smart</span>
            <br />
            <span className="text-yellow-400">75+ Courses | </span>
            <span className="text-blue-400 font-bold">100% Placement</span>
          </p>
      ...
      <div className="flex items-center justify-center mt-12 md:mt-16 px-4 text-center">
        <motion.h2
          ...
          className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold"
        >
          The <span className="text-blue-600 font-serif">IIOFT</span> Advantage
        </motion.h2>
      </div>
      <div className="py-8 md:py-16 px-4 md:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
          {PROS.map((item, i) => (
            <motion.div
              ...
              className="bg-blue-500 rounded-2xl p-4 md:p-8 shadow-lg text-center hover:scale-105 transition duration-300"
            >
              <div className="text-3xl md:text-5xl mx-auto mb-3 flex justify-center text-white">
                {item.icon}
              </div>
      ...
      {/* ── 75+ COURSES SECTION ── */}
      <section className="py-16 md:py-24 bg-linear-to-b from-gray-50 to-white px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-blue-600 mb-4">
              <span className="text-black">75+ Courses at</span> IIOFT
            </h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Master in-demand skills with our comprehensive course offerings
              across Technology, Business, and Creative Domains
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {COURSES.map((course, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-white rounded-xl p-6 shadow-md hover:shadow-xl border-2 border-blue-100 hover:border-blue-500 transition duration-300 cursor-pointer hover:scale-105"
              >
